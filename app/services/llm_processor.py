...
def interpret_query(query: str) -> dict:
    ...
    if USE_OPENAI:
        prompt = ("You are an assistant that converts natural language requests about a pandas DataFrame into a JSON operation. " +
                  "Respond ONLY with JSON describing one operation like aggregation, filter, math, pivot, unpivot, date_extract or join. " +
